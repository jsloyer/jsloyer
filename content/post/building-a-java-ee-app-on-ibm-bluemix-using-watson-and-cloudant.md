+++
categories = ["Development", "Sample Code", "Tutorial", "Video"]
...
[![catalog 300x99 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/catalog.png)](/images/2015/06/catalog.png)

Scroll down a little and click on Liberty

[![liberty 1024x585 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/liberty.png)](/images/2015/06/liberty.png)
...
[![new app Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/new-app.png)](/images/2015/06/new-app.png)
...
[![add service 1024x683 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/add-service.png)](/images/2015/06/add-service.png)

First let’s add Watson.  Scroll down until you find the "User Modeling" Service.  Go ahead and click that.

[![user modeling 1024x342 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/user-modeling.png)](/images/2015/06/user-modeling.png)

Again, all we have to do is click "Create" on the right hand side.

[![watson create Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/watson-create.png)](/images/2015/06/watson-create.png)
...
[![restage Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/restage.png)](/images/2015/06/restage.png)

Next, let’s click "Add A Service" again.

[![addserviceagain Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/addserviceagain.png)](/images/2015/06/addserviceagain.png)
This time scroll down to the bottom and choose "Cloudant".

[![cloudant 1024x245 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/cloudant.png)](/images/2015/06/cloudant.png)

Then click "Create" on the right hand side.

[![cloudantcreate Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/cloudantcreate.png)](/images/2015/06/cloudantcreate.png)

It is going to ask us to restage our app again, go ahead and click "OK".

[![cloudantrestage Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/cloudantrestage.png)](/images/2015/06/cloudantrestage.png)
...
[![cloudantclick Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/cloudantclick.png)](/images/2015/06/cloudantclick.png)

Next, go ahead and click on "Launch".  What this is going to do is Single Sign us onto our Cloudant account for us.

[![cloudantlaunch 1024x351 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/cloudantlaunch.png)](/images/2015/06/cloudantlaunch.png)
...
[![Figure5a Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/Figure5a.png)](/images/2015/06/Figure5a.png)
...
[![addnewdb Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/addnewdb.png)](/images/2015/06/addnewdb.png)

Let’s choose a name for our database, lets use "talent-manager".  You can choose something else but remember it for later…

[![dbname Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/dbname.png)](/images/2015/06/dbname.png)

On the left click replication.

[![replication Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/replication.png)](/images/2015/06/replication.png)
...
[![replicate Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/replicate.png)](/images/2015/06/replicate.png)

It is going to ask us for a password.

[![password Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/password.png)](/images/2015/06/password.png)
...
[![overviewbluemix Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/overviewbluemix.png)](/images/2015/06/overviewbluemix.png)

To get the password for Cloudant click "Show Credentials" on the Cloudant tile.

[![credentialsshow Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/credentialsshow.png)](/images/2015/06/credentialsshow.png)
...
[![password1 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/password1.png)](/images/2015/06/password1.png)

Let’s switch back to our Cloudant tab.  We paste the paste in (step 1), and then click "Continue Replication" (step 2).

[![enterpassword Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/enterpassword.png)](/images/2015/06/enterpassword.png)

The copy has started, let’s go ahead and click "Databases" on the top left.

[![datagbases Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/datagbases.png)](/images/2015/06/datagbases.png)
...
[![copydone 1024x219 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/copydone.png)](/images/2015/06/copydone.png)
Ok now onto the code, let’s launch Eclipse.

In Eclipse, right click on the project’s area on the left.

[![import Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/import.png)](/images/2015/06/import.png)

Under General click existing project into workspace and click next

[![existingproject Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/existingproject.png)](/images/2015/06/existingproject.png)
...
[![finishimport Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/finishimport.png)](/images/2015/06/finishimport.png)
...
[![antbuild 1024x528 Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/antbuild.png)](/images/2015/06/antbuild.png)

In the bottom it should say "BUILD SUCESSFULL".

[![buildfinished Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/buildfinished.png)](/images/2015/06/buildfinished.png)
...
[![appname Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/appname.png)](/images/2015/06/appname.png)
...
[![apprunning Building a Java EE app on IBM Bluemix Using Watson and Cloudant ](/images/2015/06/apprunning.png)](/images/2015/06/apprunning.png)
